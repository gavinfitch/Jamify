                    ...
                    <div className="playlist_container">
                        <ul>
                            {userPlaylistsArr && userPlaylistsArr.map((playlist) => {
                                ...
                                return <li key={playlist.id} className="sideBar_playlist_container">
                                    ...
                                    <div className="sideBar_edit_delete_container">
                                        ...
                                        <div onClick={() => deletePlaylist(playlist.id, playlist.coverPhoto_s3Name)}><i className="fas fa-trash-alt"></i></div>
                                    </div>
                                </li>
                            })}
                        </ul>
